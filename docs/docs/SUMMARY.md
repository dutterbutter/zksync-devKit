...
* [🧪 TEST & DEBUG](../test-and-debug/README.md)
  ...
  * [Era Test Node](../test-and-debug/era-test-node/README.md)
    ...
    * [Deploying contracts](../test-and-debug/era-test-node/deploying-contracts.md)
    * [Testing bootloader and system contracts](../test-and-debug/era-test-node/testing-bootloader-and-system-contracts.md)
    * [Writing and running tests](../test-and-debug/era-test-node/writing-and-running-tests.md)
