...
TODO: \
\- follow similar structure to hardhat docs for consistency
...
* Introduction to the plugin and its capabilities.
...
* Adding the plugin to `hardhat.config.js` or `hardhat.config.ts`.
* Configuring Etherscan API keys.
...
#### Multiple API Keys & Block Explorers

*

#### Programmatically Using the Plugin
