---
description: Learn to use DIA data feeds for fetching real-time price rates.
---
...
<pre class="language-bash"><code class="lang-bash"><strong>npx zksync-cli@latest create-project DIAOracle
</strong></code></pre>
